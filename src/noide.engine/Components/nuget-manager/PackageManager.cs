...
namespace noide
{
	partial class NugetManagerFactory
	{
		private class NugetManager : IPackageManager
		{
			private readonly IProcessFactory processFactory;
			private readonly IFileService fileService;

			public NugetManager(IProcessFactory processFactory, IFileService fileService)
			{
